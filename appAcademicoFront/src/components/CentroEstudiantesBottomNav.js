...
const ITEMS = [
  { name: 'Inicio',       icon: 'home',           route: 'DashboardCentro' },
  { name: 'Docentes',     icon: 'person',         route: 'DocentesCentro' },
  { name: 'Actividades',  icon: 'checkmark-done', route: 'ActividadesCentro' },
  { name: 'Periodos',     icon: 'calendar',       route: 'PeriodosCentro' },
  { name: 'Notificar',    icon: 'notifications',  route: 'NotificacionCentro' },
  { name: 'Perfil',       icon: 'person-circle',  route: 'PerfilCentro' },
];

export default function CentroEstudiantesBottomNav({ navigation, active }) {
  return (
