...
import { remove } from '../../services/usuarioService';
import getErrorMessage from '../../utils/apiError';
import BottomNav from '../../components/BottomNav';

// Solo roles que el director puede gestionar en su carrera
const ROLES = [
...
export default function UsuariosScreen({ navigation }) {
  ...
  const loadUsuarios = useCallback(async () => {
    ...
    try {
      setLoading(true);
      // Cargar solo usuarios de la carrera del director
      const response = await api.get(`/usuarios?carrera_id=${carreraId}`);
    ...
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <View>
            <Text style={styles.headerTitle}>Usuarios de {carreraNombre}</Text>
            <Text style={styles.headerSubtitle}>{stats.total} usuarios de tu carrera</Text>
          </View>
