...
export default function PerfilCentroEstudiantesScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <CentroEstudiantesBottomNav navigation={navigation} active="PerfilCentro" />
    </SafeAreaView>
  );
}
...
const styles = StyleSheet.create({
  ...
  email:      { color: '#ddd6fe', marginTop: 5, fontWeight: '600' },
