...
const DESTINOS = [
  { value: 'estudiantes', label: 'Estudiantes', sub: 'Solo estudiantes de la carrera' },
  { value: 'todos',       label: 'Todos en la carrera', sub: 'Todos los usuarios de la carrera' },
];
          ...
          <View style={{ flex: 1 }}>
            ...
            {carreraNombre ? (
              <View style={s.badge}>
                ...
                <Text style={s.badgeText}>{carreraNombre}</Text>
              </View>
            ) : null}
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  cardUnread: { borderWidth: 1.5, borderColor: '#c4b5fd', backgroundColor: '#faf5ff' },
  cardPressed: { opacity: 0.92, transform: [{ scale: 0.99 }] },
  cardTop: { flexDirection: 'row', gap: 12, alignItems: 'flex-start' },
  iconBox: {
    width: 44, height: 44, borderRadius: 14,
    backgroundColor: '#f5f3ff', alignItems: 'center', justifyContent: 'center', position: 'relative',
  },
  unreadDot: {
  ...
  radioOptionActive: { backgroundColor: '#f5f3ff', borderColor: '#c4b5fd' },
  radioDot: {
  ...
  dialog: {
    ...
    alignSelf: 'center', marginHorizontal: 24,
  },
  dialogIcon: {
