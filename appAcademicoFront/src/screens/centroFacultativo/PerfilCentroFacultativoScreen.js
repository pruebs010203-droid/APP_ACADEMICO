...
export default function PerfilCentroFacultativoScreen() {
          ...
          <View style={styles.card}>
            ...
            {(usuario?.facultad?.nombre || usuario?.carrera?.facultad?.nombre) ? (
              <InfoRow
                ...
                label="Facultad"
                value={usuario?.facultad?.nombre || usuario?.carrera?.facultad?.nombre}
              />
            ) : null}
          </View>
...
const styles = StyleSheet.create({
  ...
  email:      { color: '#bae6fd', marginTop: 5, fontWeight: '600' },
